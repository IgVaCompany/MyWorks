...
\bibitem{five} {Goryacheva I.G., Dosaev M.Z., Selyutskiy Y.V., Yakovenko A.A., Hsiao C., Huang C., Ju M., Yeh C. Control of Insertion of Indenter into Viscoelastic Tissue using a Piezoelectric Drive. Mekhatronika, Avtomatizatsiya, Upravlenie. 2020;21(5):304-311. (In Russ.) https://doi.org/10.17587/mau.21.304-311}
\bibitem{six}{M. Khadem, B. Fallahi, C. Rossa, R. S. Sloboda, N. Usmani and M. Tavakoli,
"A mechanics-based model for simulation and control of flexible needle
insertion in soft tissue," 2015 IEEE International Conference on Robotics
and Automation (ICRA), Seattle, WA, USA, 2015, pp. 2264-2269, doi:
10.1109/ICRA.2015.7139499.}
\bibitem{seven}{Shan Jiang, Pan Li, Yan Yu, Jun Liu, Zhiyong Yang, Experimental study of
needle–tissue interaction forces: Effect of needle geometries, insertion
methods and tissue characteristics, Journal of Biomechanics, Volume 47,
Issue 13, 2014, Pages 3344-3353,
https://doi.org/10.1016/j.jbiomech.2014.08.007.}
