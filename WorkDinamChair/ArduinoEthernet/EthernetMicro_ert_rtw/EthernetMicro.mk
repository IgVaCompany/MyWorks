...
## Generated on : Tue Aug 07 23:05:28 2018
...
DEFINES_ = -DMODEL=EthernetMicro -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DONESTEPFCN=1 -DTERMFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DRT -DSTACK_SIZE=64 -DMW_TIMERID=5 -DMW_PRESCALAR=1024 -DMW_TIMERCOUNT=49911 -DMW_SCHEDULERCOUNTER=1 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_BAUDRATE_SERIAL1_=9600 -D_RTT_BAUDRATE_SERIAL2_=9600 -D_RTT_BAUDRATE_SERIAL3_=9600 -D_RTT_ANALOG_REF_=0 -D_RTT_TCP_SERVER_PORT_ORDERED=5896 -D_RTT_TCP_=1 -D_RTT_Local_IP1=192 -D_RTT_Local_IP2=168 -D_RTT_Local_IP3=0 -D_RTT_Local_IP4=20 -D_RTT_Local_MAC1=0xDE -D_RTT_Local_MAC2=0xAD -D_RTT_Local_MAC3=0xBE -D_RTT_Local_MAC4=0xEF -D_RTT_Local_MAC5=0xFE -D_RTT_Local_MAC6=0xED
...
DEFINES_STANDARD = -DMODEL=EthernetMicro -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
