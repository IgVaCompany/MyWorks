...
## Generated on : Wed Aug 08 18:31:23 2018
## MATLAB Coder version: 3.0 (R2015b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/EthernetMicro.elf
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/Druzhinin_Vasily/Documents/My_Project/GAM/trunk/WorkDinamChair/ArduinoEthernet
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/EthernetMicro.elf
...
INCLUDES_BUILDINFO = -IC:/MATLAB/SupportPackages/R2015b/arduinobase/toolbox/target/supportpackages/arduinobase/include -IC:/MATLAB/SupportPackages/R2015b/arduinobase/toolbox/target/supportpackages/arduinobase/blocks/sfcn/include -I$(START_DIR)/EthernetMicro_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino -I$(ARDUINO_ROOT)/hardware/arduino/avr/variants/mega -IC:/MATLAB/SupportPackages/R2015b/arduino/toolbox/target/supportpackages/arduinotarget/registry/../include -IC:/MATLAB/SupportPackages/R2015b/arduino/toolbox/target/supportpackages/arduinotarget/registry/../scheduler/include -IC:/MATLAB/SupportPackages/R2015b/arduino-1.6.1/libraries/Ethernet/src -IC:/MATLAB/SupportPackages/R2015b/arduino-1.6.1/libraries/Ethernet/src/utility -IC:/MATLAB/SupportPackages/R2015b/arduino-1.6.1/hardware/arduino/avr/libraries/SPI
...
DEFINES_ = -DMODEL=EthernetMicro -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DONESTEPFCN=1 -DTERMFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=1 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DRT -DSTACK_SIZE=64 -DMW_TIMERID=5 -DMW_PRESCALAR=256 -DMW_TIMERCOUNT=59286 -DMW_SCHEDULERCOUNTER=1 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_BAUDRATE_SERIAL1_=9600 -D_RTT_BAUDRATE_SERIAL2_=9600 -D_RTT_BAUDRATE_SERIAL3_=9600 -D_RTT_ANALOG_REF_=0 -D_RTT_UDP_LOCAL_PORT_ORDERED="56789" -D_RTT_UDP_=1 -D_RTT_Local_IP1=192 -D_RTT_Local_IP2=168 -D_RTT_Local_IP3=110 -D_RTT_Local_IP4=198 -D_RTT_Local_MAC1=0xDE -D_RTT_Local_MAC2=0xAD -D_RTT_Local_MAC3=0xBE -D_RTT_Local_MAC4=0xEF -D_RTT_Local_MAC5=0xFE -D_RTT_Local_MAC6=0xED
...
DEFINES_STANDARD = -DMODEL=EthernetMicro -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/EthernetMicro_ert_rtw/EthernetMicro.c $(START_DIR)/EthernetMicro_ert_rtw/EthernetMicro_data.c $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/hooks.c $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/WInterrupts.c $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/wiring.c $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/wiring_analog.c $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/wiring_digital.c $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/wiring_pulse.c $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/wiring_shift.c $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/abi.cpp $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/CDC.cpp $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/HardwareSerial.cpp $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/HardwareSerial0.cpp $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/HardwareSerial1.cpp $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/HardwareSerial2.cpp $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/HardwareSerial3.cpp $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/HID.cpp $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/IPAddress.cpp $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/new.cpp $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/Print.cpp $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/Stream.cpp $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/Tone.cpp $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/USBCore.cpp $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/WMath.cpp $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/WString.cpp C:/MATLAB/SupportPackages/R2015b/arduino/toolbox/target/supportpackages/arduinotarget/registry/../src/MW_ArduinoHWInit.cpp C:/MATLAB/SupportPackages/R2015b/arduinobase/toolbox/target/supportpackages/arduinobase/src/io_wrappers.cpp C:/MATLAB/SupportPackages/R2015b/arduino/toolbox/target/supportpackages/arduinotarget/registry/../scheduler/src/arduinoAVRScheduler.cpp C:/MATLAB/SupportPackages/R2015b/arduino-1.6.1/libraries/Ethernet/src/Ethernet.cpp C:/MATLAB/SupportPackages/R2015b/arduino-1.6.1/libraries/Ethernet/src/Dhcp.cpp C:/MATLAB/SupportPackages/R2015b/arduino-1.6.1/libraries/Ethernet/src/Dns.cpp C:/MATLAB/SupportPackages/R2015b/arduino-1.6.1/libraries/Ethernet/src/EthernetClient.cpp C:/MATLAB/SupportPackages/R2015b/arduino-1.6.1/libraries/Ethernet/src/EthernetServer.cpp C:/MATLAB/SupportPackages/R2015b/arduino-1.6.1/libraries/Ethernet/src/EthernetUdp.cpp C:/MATLAB/SupportPackages/R2015b/arduino-1.6.1/libraries/Ethernet/src/utility/socket.cpp C:/MATLAB/SupportPackages/R2015b/arduino-1.6.1/libraries/Ethernet/src/utility/w5100.cpp C:/MATLAB/SupportPackages/R2015b/arduino-1.6.1/hardware/arduino/avr/libraries/SPI/SPI.cpp

MAIN_SRC = $(START_DIR)/EthernetMicro_ert_rtw/ert_main.c
...
%.o : $(START_DIR)/EthernetMicro_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/EthernetMicro_ert_rtw/%.s
	$(AS) $(ASFLAGS)  "$@" "$<"


%.o : $(START_DIR)/EthernetMicro_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(MATLAB_ROOT)/toolbox/rtw/targets/xpc/target/build/xpcblocks/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(MATLAB_ROOT)/toolbox/rtw/targets/xpc/target/build/xpcblocks/%.s
	$(AS) $(ASFLAGS)  "$@" "$<"


%.o : $(MATLAB_ROOT)/toolbox/rtw/targets/xpc/target/build/xpcblocks/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Ethernet.o : C:/MATLAB/SupportPackages/R2015b/arduino-1.6.1/libraries/Ethernet/src/Ethernet.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


Dhcp.o : C:/MATLAB/SupportPackages/R2015b/arduino-1.6.1/libraries/Ethernet/src/Dhcp.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


Dns.o : C:/MATLAB/SupportPackages/R2015b/arduino-1.6.1/libraries/Ethernet/src/Dns.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


EthernetClient.o : C:/MATLAB/SupportPackages/R2015b/arduino-1.6.1/libraries/Ethernet/src/EthernetClient.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


EthernetServer.o : C:/MATLAB/SupportPackages/R2015b/arduino-1.6.1/libraries/Ethernet/src/EthernetServer.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


EthernetUdp.o : C:/MATLAB/SupportPackages/R2015b/arduino-1.6.1/libraries/Ethernet/src/EthernetUdp.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


socket.o : C:/MATLAB/SupportPackages/R2015b/arduino-1.6.1/libraries/Ethernet/src/utility/socket.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


w5100.o : C:/MATLAB/SupportPackages/R2015b/arduino-1.6.1/libraries/Ethernet/src/utility/w5100.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


SPI.o : C:/MATLAB/SupportPackages/R2015b/arduino-1.6.1/hardware/arduino/avr/libraries/SPI/SPI.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
