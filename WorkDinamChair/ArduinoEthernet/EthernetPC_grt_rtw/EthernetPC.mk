###########################################################################
## Makefile generated for Simulink model 'EthernetPC'. 
## 
## Makefile     : EthernetPC.mk
## Generated on : Wed Aug 08 09:26:28 2018
## MATLAB Coder version: 3.0 (R2015b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/EthernetPC.exe
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = EthernetPC_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = EthernetPC_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/EthernetPC.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR)/EthernetPC_grt_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
DEFINES_STANDARD = -DMODEL=EthernetPC -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)/EthernetPC_grt_rtw/EthernetPC.c $(START_DIR)/EthernetPC_grt_rtw/EthernetPC_data.c $(START_DIR)/EthernetPC_grt_rtw/rtGetInf.c $(START_DIR)/EthernetPC_grt_rtw/rtGetNaN.c $(START_DIR)/EthernetPC_grt_rtw/rt_nonfinite.c rt_logging.c
...
OBJS = EthernetPC.obj EthernetPC_data.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_logging.obj
...
%.obj : $(START_DIR)/EthernetPC_grt_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
